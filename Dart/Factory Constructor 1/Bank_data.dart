...
import 'bankfactory.dart';

void main()
{
  stdout.write("Enter Bank Number {0 to 34} N : ");
  int n=int.parse(stdin.readLineSync()!);
  BankingModel b=BankingModel.frombanking(Banking: bankData[n]);
   print("isActive ${b.isActive}");
  print("balance ${b.balance}");
  print("age ${b.age}");
  print("eyeColor ${b.eyeColor}");
  print("name ${b.name}");
  ...
  // print(bankData.length);
}
class Banking {
  late bool isActive;
  late String balance,eyeColor,name,gender,company,email,phone,address;
  late int age;
  Banking({required this.isActive,required this.address,required this.age,required this.balance,required this.company,required this.email,required this.eyeColor,required this.gender,required this.name,required this.phone});
}
List bankData = [
  {
    "isActive": false,
